...
path = './Datasets/I-raven_distribute_nine_tokens.pkl'
f=open(path,'rb')
...
class Raven_Data(Data.Dataset):
    ...
    def __getitem__(self, index):
            ...
            a = int(label_dict[opt_path.split('/')[-1]])

    
            return target['image'].reshape(16,160,160)[[0,1,2,3,4,5,6,7,idx + 8],],  a, idx
